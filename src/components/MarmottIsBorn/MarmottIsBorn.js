...
import css from './MarmottIsBorn.module.css';
...
class CookieConsent extends Component {
  ...
  onAcceptCookies() {
    // Next line = remember the button haas been clicked => alert will not show again
      ...
      return (
        <div className={classes}>
          <div className={css.message}>
            {/* <FormattedMessage id="MarmottIsBorn.message" values={{linebreak: <br/>}}/> */}
            <FormattedMessage id="MarmottIsBorn.message" />
          </div>
          <button className={css.continueBtn} onClick={this.onAcceptCookies}>
            <FormattedMessage id="MarmottIsBorn.continue" />
          </button>
        </div>
      );
    }
