...
import routeConfiguration from '../../routing/routeConfiguration';//../routeConfiguration';
                     ...
                     {shoppingCartItems.map(item => {
                         ...
                         return(
                             <div className={css.cartItem}>
                                 <div>
                                  <span>{item.checkoutValues.quantity} x <a onClick={() => pushToPath(`/l/${item.listing.attributes.title.replace(' ','-')}/${item.listing.id.uuid}`)}>{item.listing.attributes.title}</a></span> 
                                 </div>
                                 <div>
                                    <DeleteOutlineIcon
