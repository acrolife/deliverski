...
export const EditListingDeliveryFormComponent = props => (
  <FinalForm
    ...
    render={formRenderProps => {
      ...
      // FIXME Will need to be set as an .env var, same in src/util/validators.js
      // values.location = "Arc 1800, Les Arcs, Bourg-Saint-Maurice, Savoie 73700, France"
      ...
      return (
        <Form className={classes} onSubmit={handleSubmit}>
          ...
          <div className={pickupClasses}>
            ...
            Originally field.
            FIXME
            There was a warning to solve :
            - index.js:1 Warning: Failed prop type: Invalid prop `input.value` supplied to `LocationAutocompleteInputImpl`, expected one of type [string].
            ...
            Seems to be when pickup is selected, then unselected. 
