...
class StripePaymentForm extends Component {
  ...
  paymentForm(formRenderProps) {
    ...
    const submitDisabled =
      invalid || onetimePaymentNeedsAttention || submitInProgress || this.props.isRestaurantClosed;
    ...
    const messagePlaceholder = intl.formatMessage({ id: 'StripePaymentForm.messagePlaceholder' });
