  ...
  const panel = isDataAvailable ? (
    <TransactionPanel
      ...
      markDeliveredFromPurchasedProps={{
        ...
        errorText: intl.formatMessage({ id: 'TransactionPage.markDeliveredFromPurchased.actionError' }),
      }}
      markDeliveredProps={{
...
const mapDispatchToProps = dispatch => {
  return {
    ...
    onMarkDeliveredFromPurchased: transactionId => dispatch(markDeliveredFromPurchased(transactionId)),
