...
export const MARK_DELIVERED_FROM_PURCHASED_REQUEST =
  'app/TransactionPage/MARK_DELIVERED_FROM_PURCHASED_REQUEST';
export const MARK_DELIVERED_FROM_PURCHASED_SUCCESS =
  'app/TransactionPage/MARK_DELIVERED_FROM_PURCHASED_SUCCESS';
export const MARK_DELIVERED_FROM_PURCHASED_ERROR =
  'app/TransactionPage/MARK_DELIVERED_FROM_PURCHASED_ERROR';
...
export default function checkoutPageReducer(state = initialState, action = {}) {
  ...
  switch (type) {
    ...
    case MARK_DELIVERED_FROM_PURCHASED_REQUEST:
      return {
        ...state,
        markDeliveredFromPurchasedInProgress: true,
        markDeliveredFromPurchasedError: null,
      };
    ...
    case MARK_DELIVERED_FROM_PURCHASED_ERROR:
      return {
        ...state,
        markDeliveredFromPurchasedInProgress: false,
        markDeliveredFromPurchasedError: payload,
      };
...
export const transitionInProgress = state => {
  ...
  return (
    ...
    pageState.markPreparedInProgress ||
    pageState.markDeliveredFromPurchasedInProgress
  );
};
...
const markDeliveredFromPurchasedError = e => ({
  type: MARK_DELIVERED_FROM_PURCHASED_ERROR,
  error: true,
  payload: e,
});
...
export const markDeliveredFromPurchased = id => (dispatch, getState, sdk) => {
  ...
  return sdk.transactions
    .transition(
      { id, transition: TRANSITION_MARK_DELIVERED_FROM_PURCHASED, params: {} },
      { expand: true }
    )
    .then(response => {
      dispatch(addMarketplaceEntities(response));
