...
// New version
const transactionProcessAlias = 'flex-product-default-process/auto-delivered-120--auto-received-90-prod-v3';
...
const siteTwitterHandle = '@marmott';

// Instagram page is used in SEO schema (http://schema.org/Organization)
const siteInstagramPage = 'https://www.instagram.com/marmott/';

// Facebook page is used in SEO schema (http://schema.org/Organization)
const siteFacebookPage = 'https://www.facebook.com/Marmott/';
